...
const ListBranch = () => {
  ...
  const fetchFeedbacksByBranch = (branchId) => {
    fetch(`http://api-wedding-palace.somee.com/api/feedback/${branchId}`)
      .then((response) => response.json())
      .then((data) => {
  ...
  const submitFeedback = () => {
    ...
    fetch("http://api-wedding-palace.somee.com/api/feedback", {
      method: "POST",
      headers: {
  ...
  return (
    <>
      ...
      <Modal
        show={showModalBranch}
        onHide={closeModalBranch}
      ...
      <Modal show={showModal} onHide={() => setShowModal(false)} size="lg">
        ...
        <Modal.Body>
            ...
            {feedbackData.map((feedback) => (
              <div key={feedback.feedbackId} className="feedback-item">
                ...
                <div className="email-info">
                  ...
                  <div style={{ width: "100%" }}>{feedback.content}</div>
                  <p className="rating">
                    <Rating
          ...
          {/* Vùng nhập phản hồi */}
          <h4 style={{ textAlign: "left", left: "0" }}>
