...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    if (userId !== "") {
      const fetchAvatar = async () => {
        try {
          const response = await fetch(
            `http://api-wedding-palace.somee.com/api/account/GetAvatar?id=${userId}`
          );
          if (!response.ok) {
      ...
      const fetchInfo = async () => {
        try {
          const response = await fetch(
            `http://api-wedding-palace.somee.com/api/account/GetInFoUserById?id=${userId}`
          );
          if (!response.ok) {
      ...
      const fetchWallet = async () => {
        try {
          const response = await fetch(
            `http://api-wedding-palace.somee.com/api/wallet/${userId}`
          );
          if (!response.ok) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "http://api-wedding-palace.somee.com/api/account/Update",
        {
