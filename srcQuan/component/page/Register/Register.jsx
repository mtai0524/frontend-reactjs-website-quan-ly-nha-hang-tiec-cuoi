...
const Register = () => {
    ...
    const validateForm = () => {
        ...
        if (isEmptyValue(formValue.firstName)) {
            error["firstName"] = "First Name is the best"

        }
        if (isEmptyValue(formValue.lastName)) {
            error["lastName"] = "Last Name is the best"

        }
        if (isEmptyValue(formValue.email)) {
            error["email"] = "Email is the best"

        } else {
            if (!isEmailVaild(formValue.email)) {
                error["email"] = "Email is invalid"

            }
        }
        if (isEmptyValue(formValue.password)) {
            error["password"] = "Password is the best"

        }

        if (isEmptyValue(formValue.confirmPassword)) {
            error["confirmPassword"] = " Confirm Password is the best";
